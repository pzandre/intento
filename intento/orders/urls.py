...
from .views import OrderList, OrderDetail, CreateOrder, UpdateOrder, DeleteOrder,\
    CreateQuestion, CreateAnswer, QuestionDetail, UpdateQuestion, UpdateAnswer,\
    QuestionList, QuestionSearch, DeleteQuestion, QuestionsPDFList, QuestionListDownload,\
    load_discipline_details, load_macro_details, load_micro_details, load_teacher_details
...
urlpatterns = [
    ...
    path('order/<int:order>/question/<int:id_by_order>/answer/create/', CreateAnswer.as_view(), name='create-answer'),
    ...
    path('order/<int:order>/question/<int:id_by_order>/answer/update/', UpdateAnswer.as_view(), name='update-answer'),
    ...
    path('order/<int:order>/questions/', QuestionsPDFList.as_view(), name='order-questions'),
    path('order/<int:order>/questions/pdf-download/', QuestionListDownload.as_view(), name='pdf-download'),
