...
urlpatterns = [
    ...
    path('order/<int:question_order>/question/<int:id_by_order>/create/', CreateQuestionView.as_view(), name='new-question'),
    path('order/<int:question_order>/question/<int:id_by_order>/answer/create/', CreateAnswerView.as_view(), name='new-answer'),
    path('order/<int:question_order>/question/<int:id_by_order>/', QuestionDetailView.as_view(), name='question-detail'),
